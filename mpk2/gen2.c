...
// original gen program! :'( That is the reason why gen2 produces
// .loop.g0 instead of .g0 (and .loop.co file).
//
...
int main(int argc, char **argv) {
  ...
  /*        "the g0 file in the directory generated by
   *        ./driver\n\n"); */
  if (argc != 4) {
  usage:
